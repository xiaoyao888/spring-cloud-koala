package com.xingling.cloud.constant;
...
public interface SecurityConstants {
     ...
     * 默认的用户名密码登录请求处理url
     */
    String DEFAULT_SIGN_IN_PROCESSING_URL_FORM = "/oauth/form";
     ...
     * 默认的手机验证码登录请求处理url
     */
    String DEFAULT_SIGN_IN_URL_MOBILE_PAGE = "/oauth/mobilePage";

    /**
     * 默认的用户注册请求处理url
     */
    String DEFAULT_REGISTER_URL = "/oauth/register";
    ...
    String TOKEN_AUTH_INFO = "CURRENT_USER_INFO";
